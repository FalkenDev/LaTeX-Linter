...
## Download
### Docker
> docker run -it -v "$(pwd)/$1":/input  falkendev/latex-linter:1.0
>
> "$(pwd)/$1" = Your path
...
> | Specific File - Enter which file u want to use from input folder. All the files that are displaying in terminal can be used.
